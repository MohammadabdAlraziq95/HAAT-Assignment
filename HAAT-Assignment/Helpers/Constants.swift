...
func eE(_ val: String?) -> String {
    return (val != nil) ? val! : ""
}

func eSF(_ val: String?, para: CVarArg? = nil) -> String {
    return String(format: eE(val), para!)
}

func eSF(_ val: String?, _ para: CVarArg) -> String {
    return String(format: eE(val), para)
}
